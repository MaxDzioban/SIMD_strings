...
public:
    ...
    my_str_t(my_str_t &&other_str) noexcept;
    my_str_t &operator=(my_str_t &&other_str) noexcept;
...
my_str_t operator*(const my_str_t& str1, int count);
my_str_t operator*(int count, const my_str_t& str1);
