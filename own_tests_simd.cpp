...
int main() {
    ...
    try {
        ...
        my_str_simd str5(std::move(str3));
...
//видалення 5 стрінги
        ...
        const my_str_simd test_index = my_str_simd("hi, hello, hola!");
        // Тест на індексацію
        if (test_index[1] != 'i') {
        ...
        my_str_simd test_index_2 = my_str_simd("hi, hello, hola!");
        ...
        test_index_2[3] = 'h';
        if (test_index_2 != my_str_simd("hi,hhello, hola!")) {
    ...
    my_str_simd str(10, 'a'); // Створює стрічку з 10 'a'
    ...
    my_str_simd append_test1("Hello");
    my_str_simd append_str(" World!");
    append_test1.append(append_str);
    if (append_test1 != my_str_simd("Hello World!")) {
    ...
    my_str_simd append_test2("Hello");
    const char* append_cstr = ", C++!";
    append_test2.append(append_cstr);
    if (append_test2 != my_str_simd("Hello, C++!")) {
    ...
    my_str_simd append_test3("Welcome to");
    std::string append_cppstr = " C++ World!";
    append_test3.append(append_cppstr.c_str());
    if (append_test3 != my_str_simd("Welcome to C++ World!")) {
    ...
    my_str_simd insert_test1("Hello, World!");
    my_str_simd insert_str(" C++");
    insert_test1.insert(6, insert_str);
    if (insert_test1 != my_str_simd("Hello, C++ World!")) {
    ...
    my_str_simd insert_test2("Hello, World!");
    insert_test2.insert(5, " everyone");
    if (insert_test2 != my_str_simd("Hello everyone, World!")) {
    ...
    my_str_simd insert_test3("Hello, World!");
    std::string insert_cppstr = " and everyone";
    insert_test3.insert(6, insert_cppstr.c_str());

    if (insert_test3 != my_str_simd("Hello, and everyone World!")) {
    ...
    my_str_simd sub = str.substr(1, 3); // Копіює підстрічку
    std::cout << "Substring (1, 3): " << sub.c_str() << std::endl;

    my_str_simd test("Yaroshko");
    ...
    // Об'єкти класу my_str_simd
    my_str_simd str1("apple");
    my_str_simd str2("banana");
    my_str_simd str3("apple");
    ...
    // Тест операторів порівняння між my_str_simd і my_str_simd
    if (str1 == str3) {
        std::cout << "Test passed: str1 == str3 (my_str_simd == my_str_simd)" << std::endl;
    } else {
        std::cerr << "Test failed: str1 != str3 (my_str_simd == my_str_simd)" << std::endl;
    }

    if (str1 != str2) {
        std::cout << "Test passed: str1 != str2 (my_str_simd != my_str_simd)" << std::endl;
    } else {
        std::cerr << "Test failed: str1 == str2 (my_str_simd != my_str_simd)" << std::endl;
    }

    // Тест операторів порівняння між my_str_simd і C-style рядком
    if (str1 == cstr1) {
        std::cout << "Test passed: str1 == cstr1 (my_str_simd == const char*)" << std::endl;
    } else {
        std::cerr << "Test failed: str1 != cstr1 (my_str_simd == const char*)" << std::endl;
    }

    if (str1 != cstr2) {
        std::cout << "Test passed: str1 != cstr2 (my_str_simd != const char*)" << std::endl;
    } else {
        std::cerr << "Test failed: str1 == cstr2 (my_str_simd != const char*)" << std::endl;
    }

    // Тест операторів порівняння між my_str_simd і C++ рядком
    if (str1 == cppstr1) {
        std::cout << "Test passed: str1 == cppstr1 (my_str_simd == std::string)" << std::endl;
    } else {
        std::cerr << "Test failed: str1 != cppstr1 (my_str_simd == std::string)" << std::endl;
    }

    if (str1 != cppstr2) {
        std::cout << "Test passed: str1 != cppstr2 (my_str_simd != std::string)" << std::endl;
    } else {
        std::cerr << "Test failed: str1 == cppstr2 (my_str_simd != std::string)" << std::endl;
    }

    // Тест операторів порівняння між C-style рядком і my_str_simd
    if (cstr1 == str1) {
        std::cout << "Test passed: cstr1 == str1 (const char* == my_str_simd)" << std::endl;
    } else {
        std::cerr << "Test failed: cstr1 != str1 (const char* == my_str_simd)" << std::endl;
    }

    if (cstr2 != str1) {
        std::cout << "Test passed: cstr2 != str1 (const char* != my_str_simd)" << std::endl;
    } else {
        std::cerr << "Test failed: cstr2 == str1 (const char* != my_str_simd)" << std::endl;
    }

    // Тест операторів порівняння між C++ рядком і my_str_simd
    if (cppstr1 == str1) {
        std::cout << "Test passed: cppstr1 == str1 (std::string == my_str_simd)" << std::endl;
    } else {
        std::cerr << "Test failed: cppstr1 != str1 (std::string == my_str_simd)" << std::endl;
    }

    if (cppstr2 != str1) {
        std::cout << "Test passed: cppstr2 != str1 (std::string != my_str_simd)" << std::endl;
    } else {
        std::cerr << "Test failed: cppstr2 == str1 (std::string != my_str_simd)" << std::endl;
    }
    // Додаткові тести на конструктори переміщення та оператори +
    {
        my_str_simd concat_str1("Hello, ");
        my_str_simd concat_str2("World!");
        const char* concat_cstr = " C++!";
        std::string concat_cppstr = " Welcome!";

        // Тест оператора +
        my_str_simd concat_result = concat_str1 + concat_str2;
        if (concat_result == my_str_simd("Hello, World!")) {
        ...
        if (concat_result == my_str_simd("Hello,  C++!")) {
        ...
        if (concat_result == my_str_simd("Hello,  Welcome!")) {
        ...
        // Тест оператора += з my_str_simd
        concat_str1 += concat_str2;
        if (concat_str1 == my_str_simd("Hello, World!")) {
            std::cout << "Test passed: concat_str1 += concat_str2 == 'Hello, World!'" << std::endl;
        } else {
            std::cerr << "Test failed: concat_str1 += concat_str2 != 'Hello, World!'" << std::endl;
        }
        ...
        if (concat_str1 == my_str_simd("Hello, World! C++!")) {
        ...
        if (concat_str1 == my_str_simd("Hello, World! C++! Welcome!")) {
        ...
        // Оператори * і *=
        my_str_simd repeat_str1("abc");

        // Тест оператора *
        my_str_simd repeat_result = repeat_str1 * 3;
        if (repeat_result == my_str_simd("abcabcabc")) {
        ...
        // Тест оператора *=
        repeat_str1 *= 2;
        if (repeat_str1 == my_str_simd("abcabc")) {
            std::cout << "Test passed: repeat_str1 *= 2 == 'abcabc'" << std::endl;
        } else {
            std::cerr << "Test failed: repeat_str1 *= 2 != 'abcabc'" << std::endl;
        }
        my_str_simd* test_obj = new my_str_simd("Test string");
        delete test_obj;
        test_obj = nullptr;
        // Порівняння my_str_simd з my_str_simd
        if (str2 > str1) {
        ...
        // Порівняння my_str_simd з const char*
        if (cstr2 > str1) {
        ...
        // Порівняння my_str_simd з std::string
    ...
    my_str_simd str1lesseq("apple");
    my_str_simd str2lesseq("banana");
    my_str_simd str3lesseq("apple");
    my_str_simd str4lesseq("appl");
    ...
    if (str4lesseq <= str1lesseq) {
        std::cout << "Test passed: str4 <= str1 (my_str_simd <= my_str_simd)" << std::endl;
    } else {
        std::cerr << "Test failed: str4 > str1 (my_str_simd <= my_str_simd)" << std::endl;
    }
